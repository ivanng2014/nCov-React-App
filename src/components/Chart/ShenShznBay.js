...
export default props => {
  useEffect(() => {
    var ctx = document.getElementById("ShenZhenBay").getContext("2d");
        ...
        var myChart = new Chart(ctx, {
          ...
          data: {
            ...
            datasets: [
              {
                data: [
                  latest.data.深圳灣.totalArrival,
                  latest.data.深圳灣.totalDepartue
                ],
                backgroundColor: [
                  "rgba(255, 99, 132, 0.2)",
                  "rgba(99, 255, 132, 0.2)"
  ...
  return (
    <div>
      <Paper elevation={3} style={{ marginTop: 10, padding: 30 }}>
        ...
        <canvas id="ShenZhenBay" height="250"></canvas>
      </Paper>
    </div>
  );
};
